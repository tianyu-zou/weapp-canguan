...
Page({
  ...
  onLoad: function () {
    ...
    var that = this; 
    wx.request({
      url: 'https://api.getweapp.com/vendor/honglingjinclub/product/list?communityid=82', //仅为示例，并非真实的接口地址
      data:{},
      header: {
    ...
    wx.request({
      url: 'https://api.getweapp.com/vendor/honglingjinclub/banner/list?communityid=82', //仅为示例，并非真实的接口地址
      data:{},
      header: {
          'Content-Type': 'application/json'
      },
